...
'	objTextFile.WriteLine indent4 & "</distribution>" 
	...
	emergencystop=0
	'Remember the dataset so we can skip in regular rs in tandem at the loop statement.  
	'we will use that dataset_id stored in MDataSetMultiID   .............  See the loop statement down there paired to this DO
