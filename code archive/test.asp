...
Set objTextFile2 = objFSO.CreateTextFile("c:\inetpub\wwwroot\metacat_harvest\harvestlist.xml", true)
Set objTextFile3 = objFSO.CreateTextFile("c:\inetpub\wwwroot\metacat_harvest\frame7-page_1_auto.asp", true)
...
Const Filename = "/metacat_harvest/lter_revision_no.txt"	' file to read
...
do while not rs.EOF and emergencystop<2000
	...
	tfname="c:\inetpub\wwwroot\metacat_harvest\bes_" & cname & ".xml"  ' Be careful:  tfname is the ACTUAL filename we are writing to.  So do not change it or you might spew destruction all over the server's disk
	...
	objTextFile2.WriteLine "<documentURL>http://beslter.org/metacat_harvest/" & harvestlistname & "</documentURL>"
	objTextFile2.WriteLine "</document>"
