...
accessdb="esri2bes_int_osrs-search_jwalsh.mdb"                 ' JW enhanced cutesy variables
'accessdb="int_osrs-search_jwalsh.mdb"                 ' JW enhanced cutesy variables
'STRUCTURE OF THE DATABASE NEEDS TO BE CHANGED.  ADD Long Integer Field called ID.  ORS guys yanked it from me, it was in my original code.  Or just remove the field fromt eh code if you get the energy one day!
...
response.write "****************************** BEGkjlkjlkjIN EML OUTPUT" & "<br>" & Vbcrlf

response.write "****************************** GOT TO HERE " & "<br>" & Vbcrlf
