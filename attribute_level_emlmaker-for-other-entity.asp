...
'Open main datasets
	%>
	<!--#include file="emlmaker.open.datasets.otherentity.inc.asp"-->	
	<%
...
do while not rs.eof
	...
	rs.movenext
loop
response.write "<br>NOW IN MODULE EMLMAKER FOR OTHER ENTITY ####<BR>" 
...
do while not rs.EOF and emergencystop<2000
	...
	fname=MrecordID
	revision_no_for_this_dataset=rs("edition") * 10
...
'<eml:eml packageId="knb-lter-gce.89.17" system="knb" xmlns:ds="eml://ecoinformatics.org/dataset-2.1.0" xmlns:eml="eml://ecoinformatics.org/eml-2.1.0" xmlns:stmml="http://www.xml-cml.org/schema/stmml-1.1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="eml://ecoinformatics.org/eml-2.1.0 http://gce-lter.marsci.uga.edu/public/files/schemas/eml-210/eml.xsd">
	...
	response.write "<br>Filename is " & tfname & " *** "
...
'response.write trim(rs("dataformat"))
...
''		objTextFile.WriteLine indent6 & "</dataFormat>" 
''	else
''		if trim(rs("dataformat"))="Rich Text" then
''		'I Guess nothing goes in here for OtherEntity
''		end if
''	end if
...
''	%>
''	<!--'Took out thej # '''include file="write.eml.accesspermissionsdownload.inc.asp"-->	
''	<%
...
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
	' Module to write attributes to file for this dataset_id  NOT DOING THIS FOR OTHERENTITYTYPE BUT GOING TO LEAVE CODE COMMENTED OUT
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
...
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
'                                               WRITE IN OtherEntity Tages
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@

	objTextFile.WriteLine indent4 & "<otherEntity id=""BES Datatype OtherEntity""	system=""BES system name for other entity"">"
	objTextFile.WriteLine indent5 & "<entityName>" & rs("title") & "</entityName>"
	objTextFile.WriteLine indent5 & "<entityDescription>" & rs("onlinedescription") & "</entityDescription>"
	objTextFile.WriteLine indent5 & "<physical>"
	objTextFile.WriteLine indent6 & "<objectName>" & rs("filename") & "</objectName>"
	objTextFile.WriteLine indent6 & "<size unit=""" & rs("filesizeunit") & """>" & rs("filesize") & "</size>"
	objTextFile.WriteLine indent6 & "<dataFormat>"
	objTextFile.WriteLine indent6 & "<externallyDefinedFormat>"
	objTextFile.WriteLine indent7 & "<formatName>" & rs("filetype") & "</formatName>"
	objTextFile.WriteLine indent6 & "</externallyDefinedFormat>"
	objTextFile.WriteLine indent6 & "</dataFormat>"
	objTextFile.WriteLine indent6 & "<distribution>"
	objTextFile.WriteLine indent6 & "<online>"
	objTextFile.WriteLine indent7 & "<onlineDescription>" & rs("onlinedescription") &"</onlineDescription>"
	objTextFile.WriteLine indent7 & "<url function=""download"">" & rs("onlinelinkage") & "</url>"
	objTextFile.WriteLine indent6 & "</online>"
	objTextFile.WriteLine indent6 & "</distribution>"
	objTextFile.WriteLine indent5 & "</physical>"
	objTextFile.WriteLine indent5 & "<entityType>" & rs("dataformat") & "</entityType>"
	objTextFile.WriteLine indent5 & "</otherEntity>"


'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
'                                               Finish WRITE IN OtherEntity Tags
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
'###############@@@@@@@@@@@@@@@@@@@@@#################@@@@@@@@@@@@@@@@@@@###################@@@@@@@@@@@@@@@@@
